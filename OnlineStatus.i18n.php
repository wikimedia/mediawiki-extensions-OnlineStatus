...
$messages['uk'] = array(
	...
	'onlinestatus-subtitle-offline' => '{{GENDER:$1|Цей користувач|Ця користувачка}} наразі офлайн', # Fuzzy
	'onlinestatus-subtitle-online' => '{{GENDER:$1|Цей користувач|Ця користувачка}} наразі онлайн', # Fuzzy
	'onlinestatus-tab' => 'Статус',
	'onlinestatus-toggles-desc' => 'Ваш статус:',
